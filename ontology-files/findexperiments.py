...
if __name__ == "__main__":
	...
	molecule = input("Is the molecule you're working with a type of protein? ")
	if molecule.lower() == "protein" or molecule.lower() == "y" or molecule.lower() == "yes":
		...
		#DONE WITH LOCATION
		if typeprotein.lower() == "location" or typeprotein.lower() == "l":
		...
		#done with structure
		elif typeprotein.lower() == "structure" or typeprotein.lower() == "s":
			print("The type of experiment that you want to perform is XRay Crystalography!")
		elif typeprotein.lower() == "interaction"  or typeprotein.lower() == "i":
		...
		elif typeprotein.lower() == "quantification" or typeprotein.lower() == "q":
		...
		elif typeprotein.lower() == "detection" or typeprotein.lower() == "d":
